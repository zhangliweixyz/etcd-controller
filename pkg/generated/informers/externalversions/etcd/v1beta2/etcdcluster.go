...
import (
	...
	versioned "github.com/zhangliweixyz/etcd-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/zhangliweixyz/etcd-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1beta2 "github.com/zhangliweixyz/etcd-controller/pkg/generated/listers/etcd/v1beta2"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EtcdV1beta2().EtcdClusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EtcdV1beta2().EtcdClusters(namespace).Watch(context.TODO(), options)
			},
		},
