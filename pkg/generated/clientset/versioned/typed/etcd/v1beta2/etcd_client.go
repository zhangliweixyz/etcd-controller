...
import (
	v1beta2 "github.com/zhangliweixyz/etcd-controller/pkg/apis/etcd/v1beta2"
	"github.com/zhangliweixyz/etcd-controller/pkg/generated/clientset/versioned/scheme"
	"net/http"
...
// NewForConfigAndClient creates a new EtcdV1beta2Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*EtcdV1beta2Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
